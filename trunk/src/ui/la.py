...
class LAFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.word_panel_copy_copy_copy_staticbox = wx.StaticBox(self.panel_2, -1, "Words:")
		self.word_panel_copy_copy_staticbox = wx.StaticBox(self.panel_2, -1, "Words:")
		self.word_panel_copy_staticbox = wx.StaticBox(self.panel_2, -1, "Words:")
		...
		self.pos_label_copy_copy = wx.StaticText(self.panel_2, -1, "Part of Speech")
		self.pos_ctrl_copy_copy = wx.ComboBox(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
		self.lemma_categories_label_copy_copy = wx.StaticText(self.panel_2, -1, "Categories")
		self.lemma_category_ctrl_copy_copy = CategoryPanelComboCtrl(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
		self.lemma_ctrl_copy = wx.ListBox(self.panel_2, -1, choices=[], style=wx.LB_SINGLE|wx.LB_SORT)
		self.entry_form_label_copy_copy_copy = wx.StaticText(self.panel_2, -1, "Entry Form")
		self.gloss_ctrl_copy_copy_copy_copy = wx.TextCtrl(self.panel_2, -1, "")
		self.pos_label_copy_copy_1_copy = wx.StaticText(self.panel_2, -1, "Part of Speech")
		self.pos_ctrl_copy_copy_1_copy = wx.ComboBox(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
		self.lemma_categories_label_copy_copy_1_copy = wx.StaticText(self.panel_2, -1, "Categories")
		self.lemma_category_ctrl_copy_copy_1_copy = CategoryPanelComboCtrl(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
		self.gloss_label_copy_copy_copy = wx.StaticText(self.panel_2, -1, "Gloss")
		self.gloss_ctrl_copy_copy_1_copy = wx.TextCtrl(self.panel_2, -1, "")
		self.generate_words_button_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.new_word_button_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.delete_word_button_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.xxx_button_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.word_grid_copy_copy_copy = wx.grid.Grid(self.panel_2, -1, size=(1, 1))
		self.entry_form_label_copy_copy = wx.StaticText(self.panel_2, -1, "Entry Form")
		self.gloss_ctrl_copy_copy_copy = wx.TextCtrl(self.panel_2, -1, "")
		self.pos_label_copy_copy_1 = wx.StaticText(self.panel_2, -1, "Part of Speech")
		self.pos_ctrl_copy_copy_1 = wx.ComboBox(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
		self.lemma_categories_label_copy_copy_1 = wx.StaticText(self.panel_2, -1, "Categories")
		self.lemma_category_ctrl_copy_copy_1 = CategoryPanelComboCtrl(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
		self.gloss_label_copy_copy = wx.StaticText(self.panel_2, -1, "Gloss")
		self.gloss_ctrl_copy_copy_1 = wx.TextCtrl(self.panel_2, -1, "")
		self.generate_words_button_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.new_word_button_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.delete_word_button_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.xxx_button_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.word_grid_copy_copy = wx.grid.Grid(self.panel_2, -1, size=(1, 1))
		self.entry_form_label_copy = wx.StaticText(self.panel_2, -1, "Entry Form")
		self.gloss_ctrl_copy_copy = wx.TextCtrl(self.panel_2, -1, "")
		self.pos_label_copy = wx.StaticText(self.panel_2, -1, "Part of Speech")
		self.pos_ctrl_copy = wx.ComboBox(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
		self.lemma_categories_label_copy = wx.StaticText(self.panel_2, -1, "Categories")
		self.lemma_category_ctrl_copy = CategoryPanelComboCtrl(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
		self.gloss_label_copy = wx.StaticText(self.panel_2, -1, "Gloss")
		self.gloss_ctrl_copy = wx.TextCtrl(self.panel_2, -1, "")
		self.generate_words_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.new_word_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.delete_word_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.xxx_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.word_grid_copy = wx.grid.Grid(self.panel_2, -1, size=(1, 1))
		...
		self.Bind(wx.EVT_LISTBOX, self.OnLemmaSelect, self.lemma_ctrl_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoGenerateWords, self.generate_words_button_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoNewWord, self.new_word_button_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.delete_word_button_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.xxx_button_copy_copy_copy)
		self.Bind(wx.grid.EVT_GRID_CMD_SELECT_CELL, self.OnWordSelect, self.word_grid_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoGenerateWords, self.generate_words_button_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoNewWord, self.new_word_button_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.delete_word_button_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.xxx_button_copy_copy)
		self.Bind(wx.grid.EVT_GRID_CMD_SELECT_CELL, self.OnWordSelect, self.word_grid_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoGenerateWords, self.generate_words_button_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoNewWord, self.new_word_button_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.delete_word_button_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.xxx_button_copy)
	...
	def __set_properties(self):
		...
		self.generate_words_button_copy_copy_copy.SetMinSize((25, 25))
		self.new_word_button_copy_copy_copy.SetMinSize((25, 25))
		self.delete_word_button_copy_copy_copy.SetMinSize((25, 25))
		self.xxx_button_copy_copy_copy.SetMinSize((25, 25))
		self.word_grid_copy_copy_copy.CreateGrid(0, 2)
		self.word_grid_copy_copy_copy.SetRowLabelSize(0)
		self.word_grid_copy_copy_copy.SetColLabelSize(0)
		self.word_grid_copy_copy_copy.EnableEditing(0)
		self.word_grid_copy_copy_copy.EnableDragRowSize(0)
		self.word_grid_copy_copy_copy.EnableDragGridSize(0)
		self.word_grid_copy_copy_copy.SetSelectionMode(wx.grid.Grid.wxGridSelectRows)
		self.word_grid_copy_copy_copy.SetColLabelValue(0, "Categories")
		self.word_grid_copy_copy_copy.SetColLabelValue(1, "Form")
		self.generate_words_button_copy_copy.SetMinSize((25, 25))
		self.new_word_button_copy_copy.SetMinSize((25, 25))
		self.delete_word_button_copy_copy.SetMinSize((25, 25))
		self.xxx_button_copy_copy.SetMinSize((25, 25))
		self.word_grid_copy_copy.CreateGrid(0, 2)
		self.word_grid_copy_copy.SetRowLabelSize(0)
		self.word_grid_copy_copy.SetColLabelSize(0)
		self.word_grid_copy_copy.EnableEditing(0)
		self.word_grid_copy_copy.EnableDragRowSize(0)
		self.word_grid_copy_copy.EnableDragGridSize(0)
		self.word_grid_copy_copy.SetSelectionMode(wx.grid.Grid.wxGridSelectRows)
		self.word_grid_copy_copy.SetColLabelValue(0, "Categories")
		self.word_grid_copy_copy.SetColLabelValue(1, "Form")
		self.generate_words_button_copy.SetMinSize((25, 25))
		self.new_word_button_copy.SetMinSize((25, 25))
		self.delete_word_button_copy.SetMinSize((25, 25))
		self.xxx_button_copy.SetMinSize((25, 25))
		self.word_grid_copy.CreateGrid(0, 2)
		self.word_grid_copy.SetRowLabelSize(0)
		self.word_grid_copy.SetColLabelSize(0)
		self.word_grid_copy.EnableEditing(0)
		self.word_grid_copy.EnableDragRowSize(0)
		self.word_grid_copy.EnableDragGridSize(0)
		self.word_grid_copy.SetSelectionMode(wx.grid.Grid.wxGridSelectRows)
	...
	def __do_layout(self):
		...
		lemma_sizer_copy = wx.FlexGridSizer(2, 1, 0, 0)
		lemma_button_sizer_copy = wx.GridSizer(1, 2, 0, 0)
		sizer_8 = wx.BoxSizer(wx.HORIZONTAL)
		lemma_sizer_copy_1 = wx.FlexGridSizer(2, 1, 0, 0)
		word_panel_copy = wx.StaticBoxSizer(self.word_panel_copy_staticbox, wx.HORIZONTAL)
		word_list_sizer_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_list_button_sizer_copy = wx.BoxSizer(wx.HORIZONTAL)
		lemma_field_sizer_copy = wx.FlexGridSizer(4, 2, 5, 0)
		lemma_sizer_copy_1_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_panel_copy_copy = wx.StaticBoxSizer(self.word_panel_copy_copy_staticbox, wx.HORIZONTAL)
		word_list_sizer_copy_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_list_button_sizer_copy_copy = wx.BoxSizer(wx.HORIZONTAL)
		lemma_field_sizer_copy_copy_1 = wx.FlexGridSizer(4, 2, 5, 0)
		lemma_sizer_copy_1_copy_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_panel_copy_copy_copy = wx.StaticBoxSizer(self.word_panel_copy_copy_copy_staticbox, wx.HORIZONTAL)
		word_list_sizer_copy_copy_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_list_button_sizer_copy_copy_copy = wx.BoxSizer(wx.HORIZONTAL)
		lemma_field_sizer_copy_copy_1_copy = wx.FlexGridSizer(4, 2, 5, 0)
		lemma_list_sizer_copy = wx.FlexGridSizer(2, 1, 0, 0)
		lemma_field_sizer_copy_copy = wx.FlexGridSizer(2, 2, 5, 0)
		...
		lemma_field_sizer_copy_copy.Add(self.pos_label_copy_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy_copy.Add(self.pos_ctrl_copy_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy.Add(self.lemma_categories_label_copy_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy.Add(self.lemma_category_ctrl_copy_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy.AddGrowableCol(1)
		lemma_list_sizer_copy.Add(lemma_field_sizer_copy_copy, 1, wx.ALL|wx.EXPAND, 5)
		lemma_list_sizer_copy.Add(self.lemma_ctrl_copy, 1, wx.EXPAND, 0)
		lemma_list_sizer_copy.AddGrowableRow(1)
		la_lexicon_sizer_copy.Add(lemma_list_sizer_copy, 1, wx.EXPAND, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.entry_form_label_copy_copy_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.gloss_ctrl_copy_copy_copy_copy, 0, wx.EXPAND, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.pos_label_copy_copy_1_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.pos_ctrl_copy_copy_1_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.lemma_categories_label_copy_copy_1_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.lemma_category_ctrl_copy_copy_1_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.gloss_label_copy_copy_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy_1_copy.Add(self.gloss_ctrl_copy_copy_1_copy, 0, wx.EXPAND, 0)
		lemma_field_sizer_copy_copy_1_copy.AddGrowableCol(1)
		lemma_sizer_copy_1_copy_copy.Add(lemma_field_sizer_copy_copy_1_copy, 1, wx.ALL|wx.EXPAND, 5)
		word_list_button_sizer_copy_copy_copy.Add(self.generate_words_button_copy_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy_copy.Add(self.new_word_button_copy_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy_copy.Add(self.delete_word_button_copy_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy_copy.Add(self.xxx_button_copy_copy_copy, 0, 0, 0)
		word_list_sizer_copy_copy_copy.Add(word_list_button_sizer_copy_copy_copy, 1, wx.EXPAND, 0)
		word_list_sizer_copy_copy_copy.Add(self.word_grid_copy_copy_copy, 0, wx.EXPAND, 0)
		word_list_sizer_copy_copy_copy.AddGrowableRow(1)
		word_list_sizer_copy_copy_copy.AddGrowableCol(0)
		word_panel_copy_copy_copy.Add(word_list_sizer_copy_copy_copy, 2, wx.EXPAND, 0)
		lemma_sizer_copy_1_copy_copy.Add(word_panel_copy_copy_copy, 1, wx.EXPAND, 0)
		lemma_sizer_copy_1_copy_copy.AddGrowableRow(1)
		lemma_sizer_copy_1_copy_copy.AddGrowableCol(0)
		sizer_8.Add(lemma_sizer_copy_1_copy_copy, 3, wx.EXPAND, 0)
		lemma_field_sizer_copy_copy_1.Add(self.entry_form_label_copy_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy_copy_1.Add(self.gloss_ctrl_copy_copy_copy, 0, wx.EXPAND, 0)
		lemma_field_sizer_copy_copy_1.Add(self.pos_label_copy_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy_copy_1.Add(self.pos_ctrl_copy_copy_1, 0, 0, 0)
		lemma_field_sizer_copy_copy_1.Add(self.lemma_categories_label_copy_copy_1, 0, 0, 0)
		lemma_field_sizer_copy_copy_1.Add(self.lemma_category_ctrl_copy_copy_1, 0, 0, 0)
		lemma_field_sizer_copy_copy_1.Add(self.gloss_label_copy_copy, 0, 0, 0)
		lemma_field_sizer_copy_copy_1.Add(self.gloss_ctrl_copy_copy_1, 0, wx.EXPAND, 0)
		lemma_field_sizer_copy_copy_1.AddGrowableCol(1)
		lemma_sizer_copy_1_copy.Add(lemma_field_sizer_copy_copy_1, 1, wx.ALL|wx.EXPAND, 5)
		word_list_button_sizer_copy_copy.Add(self.generate_words_button_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy.Add(self.new_word_button_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy.Add(self.delete_word_button_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy.Add(self.xxx_button_copy_copy, 0, 0, 0)
		word_list_sizer_copy_copy.Add(word_list_button_sizer_copy_copy, 1, wx.EXPAND, 0)
		word_list_sizer_copy_copy.Add(self.word_grid_copy_copy, 0, wx.EXPAND, 0)
		word_list_sizer_copy_copy.AddGrowableRow(1)
		word_list_sizer_copy_copy.AddGrowableCol(0)
		word_panel_copy_copy.Add(word_list_sizer_copy_copy, 2, wx.EXPAND, 0)
		lemma_sizer_copy_1_copy.Add(word_panel_copy_copy, 1, wx.EXPAND, 0)
		lemma_sizer_copy_1_copy.AddGrowableRow(1)
		lemma_sizer_copy_1_copy.AddGrowableCol(0)
		sizer_8.Add(lemma_sizer_copy_1_copy, 3, wx.EXPAND, 0)
		lemma_field_sizer_copy.Add(self.entry_form_label_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy.Add(self.gloss_ctrl_copy_copy, 0, wx.EXPAND, 0)
		lemma_field_sizer_copy.Add(self.pos_label_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		lemma_field_sizer_copy.Add(self.pos_ctrl_copy, 0, 0, 0)
		lemma_field_sizer_copy.Add(self.lemma_categories_label_copy, 0, 0, 0)
		lemma_field_sizer_copy.Add(self.lemma_category_ctrl_copy, 0, 0, 0)
		lemma_field_sizer_copy.Add(self.gloss_label_copy, 0, 0, 0)
		lemma_field_sizer_copy.Add(self.gloss_ctrl_copy, 0, wx.EXPAND, 0)
		lemma_field_sizer_copy.AddGrowableCol(1)
		lemma_sizer_copy_1.Add(lemma_field_sizer_copy, 1, wx.ALL|wx.EXPAND, 5)
		word_list_button_sizer_copy.Add(self.generate_words_button_copy, 0, 0, 0)
		word_list_button_sizer_copy.Add(self.new_word_button_copy, 0, 0, 0)
		word_list_button_sizer_copy.Add(self.delete_word_button_copy, 0, 0, 0)
		word_list_button_sizer_copy.Add(self.xxx_button_copy, 0, 0, 0)
		word_list_sizer_copy.Add(word_list_button_sizer_copy, 1, wx.EXPAND, 0)
		word_list_sizer_copy.Add(self.word_grid_copy, 0, wx.EXPAND, 0)
		word_list_sizer_copy.AddGrowableRow(1)
		word_list_sizer_copy.AddGrowableCol(0)
		word_panel_copy.Add(word_list_sizer_copy, 2, wx.EXPAND, 0)
		lemma_sizer_copy_1.Add(word_panel_copy, 1, wx.EXPAND, 0)
		lemma_sizer_copy_1.AddGrowableRow(1)
		lemma_sizer_copy_1.AddGrowableCol(0)
		sizer_8.Add(lemma_sizer_copy_1, 3, wx.EXPAND, 0)
		lemma_sizer_copy.Add(sizer_8, 1, wx.EXPAND, 0)
		lemma_button_sizer_copy.Add(self.cancel_button_copy, 0, wx.ALIGN_BOTTOM|wx.ALIGN_CENTER_HORIZONTAL, 20)
		lemma_button_sizer_copy.Add(self.apply_button_copy, 0, wx.ALIGN_BOTTOM|wx.ALIGN_CENTER_HORIZONTAL, 0)
		lemma_sizer_copy.Add(lemma_button_sizer_copy, 1, wx.ALL|wx.EXPAND, 20)
		lemma_sizer_copy.AddGrowableRow(0)
		...
		self.la_notebook.AddPage(self.panel_2, "Flexion")
