...
class LAFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.flexion_panel_staticbox = wx.StaticBox(self.panel_2, -1, "Flexions and Transforms:")
		...
		self.generate_words_button = StockBitmapButton(self.la_lexicon_pane, -1, "wxART_GO_DOWN")
		self.new_word_button = StockBitmapButton(self.la_lexicon_pane, -1, "wxART_NEW")
		self.delete_word_button = StockBitmapButton(self.la_lexicon_pane, -1, "wxART_FILE_SAVE")
		...
		self.generate_words_button_copy_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.new_word_button_copy_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.delete_word_button_copy_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.xxx_button_copy_copy_copy_copy = StockBitmapButton(self.panel_2, -1, "wxART_DELETE")
		self.tree_ctrl_1 = wx.TreeCtrl(self.panel_2, -1, style=wx.TR_HAS_BUTTONS|wx.TR_NO_LINES|wx.TR_DEFAULT_STYLE|wx.SUNKEN_BORDER)
		self.trasform_categories_label = wx.StaticText(self.panel_2, -1, "Categories")
		self.trasform_categories_ctrl = CategoryPanelComboCtrl(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
		self.generate_words_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_GO_DOWN")
		self.new_word_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_NEW")
		self.delete_word_button_copy = StockBitmapButton(self.panel_2, -1, "wxART_FILE_SAVE")
		...
		self.word_category_label_copy = wx.StaticText(self.panel_2, -1, "Categories")
		self.word_category_ctrl_copy = CategoryPanelComboCtrl(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
		self.form_label_copy = wx.StaticText(self.panel_2, -1, "Form")
		...
		self.Bind(wx.EVT_BUTTON, self.OnDoGenerateWords, self.generate_words_button_copy_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoNewWord, self.new_word_button_copy_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.delete_word_button_copy_copy_copy_copy)
		self.Bind(wx.EVT_BUTTON, self.OnDoDeleteWord, self.xxx_button_copy_copy_copy_copy)
	...
	def __set_properties(self):
		...
		self.generate_words_button_copy_copy_copy_copy.SetMinSize((25, 25))
		self.new_word_button_copy_copy_copy_copy.SetMinSize((25, 25))
		self.delete_word_button_copy_copy_copy_copy.SetMinSize((25, 25))
		self.xxx_button_copy_copy_copy_copy.SetMinSize((25, 25))
	...
	def __do_layout(self):
		...
		word_field_sizer_copy = wx.FlexGridSizer(2, 2, 5, 0)
		word_list_sizer_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_list_button_sizer_copy = wx.BoxSizer(wx.HORIZONTAL)
		transform_sizer = wx.FlexGridSizer(1, 2, 5, 0)
		lemma_list_sizer_copy = wx.FlexGridSizer(2, 1, 0, 0)
		flexion_panel = wx.StaticBoxSizer(self.flexion_panel_staticbox, wx.HORIZONTAL)
		word_list_sizer_copy_copy_copy_copy = wx.FlexGridSizer(2, 1, 0, 0)
		word_list_button_sizer_copy_copy_copy_copy = wx.BoxSizer(wx.HORIZONTAL)
		lemma_field_sizer_copy_copy = wx.FlexGridSizer(1, 2, 5, 0)
		...
		word_list_button_sizer_copy_copy_copy_copy.Add(self.generate_words_button_copy_copy_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy_copy_copy.Add(self.new_word_button_copy_copy_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy_copy_copy.Add(self.delete_word_button_copy_copy_copy_copy, 0, 0, 0)
		word_list_button_sizer_copy_copy_copy_copy.Add(self.xxx_button_copy_copy_copy_copy, 0, 0, 0)
		word_list_sizer_copy_copy_copy_copy.Add(word_list_button_sizer_copy_copy_copy_copy, 1, wx.EXPAND, 0)
		word_list_sizer_copy_copy_copy_copy.Add(self.tree_ctrl_1, 1, wx.EXPAND, 0)
		word_list_sizer_copy_copy_copy_copy.AddGrowableRow(1)
		word_list_sizer_copy_copy_copy_copy.AddGrowableCol(0)
		flexion_panel.Add(word_list_sizer_copy_copy_copy_copy, 2, wx.EXPAND, 0)
		lemma_list_sizer_copy.Add(flexion_panel, 1, wx.EXPAND, 0)
		lemma_list_sizer_copy.AddGrowableRow(1)
		lemma_list_sizer_copy.AddGrowableCol(0)
		la_lexicon_sizer_copy.Add(lemma_list_sizer_copy, 1, wx.EXPAND, 0)
		transform_sizer.Add(self.trasform_categories_label, 0, 0, 0)
		transform_sizer.Add(self.trasform_categories_ctrl, 0, 0, 0)
		transform_sizer.AddGrowableCol(1)
		lemma_sizer_copy.Add(transform_sizer, 1, wx.ALL|wx.EXPAND, 5)
		...
		word_field_sizer_copy.Add(self.word_category_label_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		word_field_sizer_copy.Add(self.word_category_ctrl_copy, 0, 0, 0)
		word_field_sizer_copy.Add(self.form_label_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		word_field_sizer_copy.Add(self.form_ctrl_copy, 0, wx.EXPAND, 0)
		word_field_sizer_copy.AddGrowableCol(1)
		word_panel_copy.Add(word_field_sizer_copy, 1, wx.ALL|wx.EXPAND, 5)
		lemma_sizer_copy.Add(word_panel_copy, 1, wx.EXPAND, 0)
		...
		lemma_sizer_copy.AddGrowableRow(1)
