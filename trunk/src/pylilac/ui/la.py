...
class LAFrame(wx.Frame):
	...
	def __init__(self, *args, **kwds):
		...
		self.inflection_panel_staticbox = wx.StaticBox(self.panel_2, -1, "Inflections and Transforms:")
	...
	def __do_layout(self):
		...
		form_sizer = wx.FlexGridSizer(1, 2, 5, 0)
		lemma_list_sizer_copy = wx.FlexGridSizer(2, 1, 0, 0)
		inflection_panel = wx.StaticBoxSizer(self.inflection_panel_staticbox, wx.HORIZONTAL)
		...
		inflection_panel.Add(word_list_sizer_copy_copy_copy_copy, 2, wx.EXPAND, 0)
		lemma_list_sizer_copy.Add(inflection_panel, 1, wx.EXPAND, 0)
		...
		form_sizer.Add(self.trasform_categories_label, 0, 0, 0)
		form_sizer.Add(self.trasform_categories_ctrl, 0, 0, 0)
		form_sizer.AddGrowableCol(1)
		lemma_sizer_copy.Add(form_sizer, 1, wx.ALL|wx.EXPAND, 5)
