...
"""
A module to create Tokipona language file.
"""
...
def run():
	...
	def build_flexions(fl):
		...
		f.rename_lemma(u"stem-form")
		f.define_paradigm(u"basic-form", (u"s",u"N",u"0"))

		tr = f.create_transform((u"s",u"Gen", u"0")) 
		c = tr.create_chain(u"stem-form")
		...
		c = tr.create_chain(u"stem-form", u"[^q]ui[^aeiouáéíóú][aeiou]$")
		c.append_step(u"$", u"va")
		c = tr.create_chain(u"stem-form", u"[aeiou][^aeiouáéíóú][aeiou]$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"ss$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"eva")
		c = tr.create_chain(u"stem-form", u"c$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"c$", u"qua")
		c = tr.create_chain(u"stem-form", u"v$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"wa")
		c = tr.create_chain(u"stem-form", u"([aeiouáéíóú]$)|([aeiouáéíóú]°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"va")
		c = tr.create_chain(u"stem-form", u"$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"wa")
		...
		c = tr.create_chain(u"stem-form", u"[aeiou][lrns]$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"[aeiou]l$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"da")
		c = tr.create_chain(u"stem-form", u"[aeiou]n$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"[aeiou][ln]$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"de")
		c = tr.create_chain(u"stem-form", u"[aeiou]t$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"se")
		c = tr.create_chain(u"stem-form", u"s$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"[aeiou][pct]$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"([aeiouáéíóúmlrn]$)|([aeiouáéíóúmlnr]°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"([aiouáíéóú]$)|([aiouáíéóú]°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"r") 
		c = tr.create_chain(u"stem-form", u"(ie$)|(ie°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"r") 
		c = tr.create_chain(u"stem-form")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"u$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"t")
		c = tr.create_chain(u"stem-form", u"ie$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"t")
		c = tr.create_chain(u"stem-form", u"^°")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"u") 
		c = tr.create_chain(u"stem-form", u"[dt].{0,3}$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"rsn$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"([aeiouáéíóú])t?[rsn]$", u"\\1lli", True)
		c = tr.create_chain(u"stem-form", u"t$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"e?$", u"ion") 

		tr = f.create_transform((u"pl",u"Poss", u"0")) 
		c = tr.create_chain(u"stem-form", u"i$|e$|(ie)$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"(l$)|(l°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"(n$)|(n°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		c = tr.create_chain(u"stem-form", u"t(s$)|(s°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"en")
		c = tr.create_chain(u"stem-form", u"(s$)|(s°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"s?s$", u"ssen")
		c = tr.create_chain(u"stem-form", u"[aeiouáéíóú]c$")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		tr = f.create_transform((u"pl",u"Instr", u"0"), (u"pl",u"Dat", u"0"))
		tr.append_step(u"$", u"en")

		tr = f.create_transform((u"pl",u"Resp", u"0"), (u"pl",u"Dat", u"0"))
		...
		c = tr.create_chain(u"stem-form", u"[aeiouáéíóú][rlsn]$")
		c.append_step(u"[^aeiou]?°", u"", True)
		c.append_step(u"$", u"to") 
		c = tr.create_chain(u"stem-form", u"([aeiouáéíóú]$)|([aeiouáéíóú]°$)")
		c.append_step(u"[^aeiou]?°", u"", True)
		...
		tr = f.create_transform((u"d", u"Poss", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"uva", True)
		tr.append_step(u"t$", u"twa", True)

		tr = f.create_transform((u"d", u"Dat", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"un", True)
		tr.append_step(u"t$", u"nt", True)

		tr = f.create_transform((u"d", u"Abl", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"ullo", True)
		tr.append_step(u"t$", u"lto", True)

		tr = f.create_transform((u"d", u"All", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"unna", True)
		tr.append_step(u"t$", u"nta", True)

		tr = f.create_transform((u"d", u"Loc", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"usse", True)
		tr.append_step(u"t$", u"tse", True)

		tr = f.create_transform((u"d", u"Instr", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"unen", True)
		tr.append_step(u"t$", u"nten", True)

		tr = f.create_transform((u"d", u"Resp", u"0"), (u"d", u"Nom", u"0"))
		tr.append_step(u"u$", u"us", True)
		tr.append_step(u"t$", u"tes", True)


		#Indirect partitive
		tr = f.create_transform((u"part", u"Gen", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"$", u"on")

		tr = f.create_transform((u"part", u"Poss", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"([^l])li$", u"\\1lí", True)
		tr.append_step(u"lli$", u"\\1li", True)
		tr.append_step(u"$", u"va")

		tr = f.create_transform((u"part", u"Dat", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"$", u"n")

		tr = f.create_transform((u"part", u"Abl", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"$", u"llon")

		tr = f.create_transform((u"part", u"All", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"$", u"nnar")

		tr = f.create_transform((u"part", u"Loc", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"$", u"ssen")

		tr = f.create_transform((u"part", u"Instr", u"0"), (u"part", u"Nom", u"0"))
		tr.append_step(u"([^l])li$", u"\\1lí", True)
		tr.append_step(u"lli$", u"\\1li", True)
		tr.append_step(u"$", u"nen")

		tr = f.create_transform((u"part", u"Resp", u"0"), (u"part", u"Nom", u"0"))
